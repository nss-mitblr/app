...
class _$EventModelImpl implements _EventModel {
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, title: $title, description: $description, date: $date, time: $time, location: $location, hours: $hours, maxVolunteers: $maxVolunteers)';
  }
...
abstract class _EventModel implements EventModel {
  const factory _EventModel(
      ...
      required final int maxVolunteers}) = _$EventModelImpl;
